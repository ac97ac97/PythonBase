...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        file_menu.Append(wx.ID_ANY, "编辑", edit_menu) #方法摒弃 后续找替代方法
        ...
        tb.AddTool(201, "back", wx.Bitmap("F:\\Python_project\\py_for\\venv\\src\\ctrl_wx\\imgs\\back.jpg"),
                   kind=wx.ITEM_NORMAL, shortHelp='Back')
        tb.AddTool(202, "forward", wx.Bitmap("F:\\Python_project\\py_for\\venv\\src\\ctrl_wx\\imgs\\forward.jpg"),
                   kind=wx.ITEM_NORMAL, shortHelp='Forward')
    ...
    def on_click(self,event):
        ...
        if event_id == 201:
            self.text.SetLabel('单击【Back】菜单')
        else:
            self.text.SetLabel('单击【Forward】菜单')
